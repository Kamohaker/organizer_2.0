  ...
  <IconButton
    ...
    <LinearGradient
      ...
      >
        ...
        w="50%" backgroundColor="#002851" borderColor="#a3e635" 
        ...
        placeholder="Numer telefonu" w="50%" backgroundColor="#002851" 
        borderColor="#a3e635" 
        ...
        <Input value={daneNumKon} variant="rounded" mx="3" my= "5"
         placeholder="Numer konta" w="50%" backgroundColor="#002851"
          borderColor="#a3e635" 
