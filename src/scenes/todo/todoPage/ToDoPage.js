...
import { Modal,FormControl,Input,Button,IconButton, ScrollView,Flex,View,Divider, FlatList,Avatar, HStack, VStack, Fab,Text, NativeBaseProvider } from "native-base";
  ...
  return (
    <NativeBaseProvider>
      ...
      <LinearGradient
        ...
        <ScrollView>
          <Avatar my= "5" marginLeft={20} size={150} background={colors.red}>
