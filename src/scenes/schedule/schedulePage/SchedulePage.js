...
import { FormControl,Input,IconButton,View,ScrollView,Avatar, HStack, VStack,Text, NativeBaseProvider } from "native-base";
  ...
  return (
    <NativeBaseProvider>
      <View style={styles.ico}>
        <HStack space={300}>
          <IconButton
            ...
            onPress={() => {navigation.navigate('Plan zajęć')
            }}>
          </IconButton>
          <IconButton
            _icon={{
      ...
      <LinearGradient
        ...
        >
          <ScrollView>
            <Avatar my= "5" marginLeft={20} size={150} background={colors.green}>
